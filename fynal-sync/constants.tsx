...
// Using SVG icons directly to avoid external dependencies for icons
export const Icons = {
  ...
  Key: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m21 2-2 2m-7.6 7.6a6 6 0 1 1-2.9-9.4L21 2h0a2 2 0 0 1 0 2.8c0 1.6-1.1 3-2.8 3.3l-.3.3"/><rect x="13" y="14" width="4" height="4" rx="1"/></svg>
  ),
  ...
  DevicePhone: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12" y2="18"/></svg>
  ),
  DeviceDesktop: (props: React.SVGProps<SVGSVGElement>) => (
